...
import type {
  ...
  ChatResponse,
  HealthStatus,
  StoreSolutionRequest,
  StoreSolutionResponse
} from './api.schemas';
...
export const getStoreChatSolutionUrl = () => {




  return `/api/chat/solution`
}

/**
 * @summary Store a helpful solution for future reference
 */
export const storeChatSolution = async (storeSolutionRequest: StoreSolutionRequest, options?: RequestInit): Promise<StoreSolutionResponse> => {

  return customFetch<StoreSolutionResponse>(getStoreChatSolutionUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(storeSolutionRequest)
  }
);}
...
export const getStoreChatSolutionMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof storeChatSolution>>, TError,{data: BodyType<StoreSolutionRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof storeChatSolution>>, TError,{data: BodyType<StoreSolutionRequest>}, TContext> => {

const mutationKey = ['storeChatSolution'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof storeChatSolution>>, {data: BodyType<StoreSolutionRequest>}> = (props) => {
          const {data} = props ?? {};

          return  storeChatSolution(data,requestOptions)
        }
 ...
 * @summary Store a helpful solution for future reference
 */
export const useStoreChatSolution = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof storeChatSolution>>, TError,{data: BodyType<StoreSolutionRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof storeChatSolution>>,
        TError,
        {data: BodyType<StoreSolutionRequest>},
        TContext
      > => {
      return useMutation(getStoreChatSolutionMutationOptions(options));
    }
